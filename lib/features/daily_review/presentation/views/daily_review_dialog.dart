...
class DailyReviewDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final menuController = Get.put(DailyPracticeMenuController());
    return SafeArea(
      child: Scaffold(
        body: Container(
                  ...
                  () => Column(
                    ...
                    children: [
                      DailyPracticeSelectionWidget(
                        ...
                        wordCount: 30,
                        onTap: () {
                          menuController.shortIsSelected.value = true;

                          menuController.mediumIsSelected.value = false;
                          menuController.completedIsSelected.value = false;
                        },
                        percent: 0.3,
                        isSelected: menuController.shortIsSelected.value,
                      ...
                      DailyPracticeSelectionWidget(
                        ...
                        wordCount: 80,
                        onTap: () {
                          menuController.mediumIsSelected.value = true;

                          menuController.shortIsSelected.value = false;
                          menuController.completedIsSelected.value = false;
                        },
                        percent: 0.7,
                        color: Color(0xFF6FCF97),
                        isSelected: menuController.mediumIsSelected.value,
                        isPremium: true,
                      ),
                      DailyPracticeSelectionWidget(
                        ...
                        wordCount: 100,
                        onTap: () {
                          menuController.completedIsSelected.value = true;
                        ...
                        isSelected: menuController.completedIsSelected.value,
                        isPremium: true,
                      ),
                    ],
                  ),
